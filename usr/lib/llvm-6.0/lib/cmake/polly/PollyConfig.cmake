...
find_package(LLVM REQUIRED CONFIG
             HINTS "/build/llvm-toolchain-6.0-wmaKPO/llvm-toolchain-6.0-6.0/build-llvm/lib/cmake/llvm")

set(Polly_CMAKE_DIR ${CMAKE_CURRENT_LIST_DIR})
set(Polly_BUNDLED_ISL ON)
set(Polly_BUNDLED_JSONCPP OFF)
set(Polly_ENABLE_GPGPU_CODEGEN OFF)

set(Polly_DEFINITIONS ${LLVM_DEFINITIONS})
set(Polly_INCLUDE_DIRS /usr/lib/llvm-6.0/include;/usr/lib/llvm-6.0/include/polly ${LLVM_INCLUDE_DIRS})
set(Polly_LIBRARY_DIRS /usr/lib/llvm-6.0/lib)
...
if (NOT TARGET Polly)
  ...
  set_property(TARGET Polly APPEND PROPERTY INTERFACE_LINK_LIBRARIES /usr/lib/aarch64-linux-gnu/libjsoncpp.so)
endif()
